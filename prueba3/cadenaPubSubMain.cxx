...
int main(int argc, char** argv)
{
	...
	// Register the type being used
		cadenaPublisher mypub;
		mypub.init();
		auto sub_thread =std::thread(&cadenaPublisher::run, mypub);

		cadenaSubscriber mysub;
		mysub.init();
		auto pub_thread =std::thread(&cadenaSubscriber::run, mysub);
	sub_thread.join();
	return 0;
}
