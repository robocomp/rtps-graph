...
#ifndef _CADENA_PUBSUBTYPES_H_
#define _CADENA_PUBSUBTYPES_H_
...
#error Generated cadena is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
